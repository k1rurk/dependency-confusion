...
import (
	...
	"dependency-confusion/internal/gau/pkg/providers/commoncrawl"
	"dependency-confusion/internal/gau/pkg/providers/otx"
	"dependency-confusion/internal/gau/pkg/providers/urlscan"
	"dependency-confusion/internal/gau/pkg/providers/wayback"
...
func (r *Runner) Init(c *providers.Config, providers []string, filters providers.Filters) error {
	...
	for _, name := range providers {
		...
		case "commoncrawl":
			...
			if err != nil {
				return fmt.Errorf("error instantiating commoncrawl: %v", err)
			}
